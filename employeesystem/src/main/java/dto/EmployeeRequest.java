...
public class EmployeeRequest {
	...
	public EmployeeRequest(int emp_id, String emp_name, String nrc, String phone, String email, String dob, String rank,
			String dep, String address, int checkdelete, InputStream filePath) {
		super();
		this.emp_id = emp_id;
